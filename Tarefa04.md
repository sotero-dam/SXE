...
5. Utiliza bind mount para que el directorio del apache2 'htdocs' esté montado un directorio que tu elijas.
...
6. Realiza un 'hola mundo' en html y comprueba que accedes desde el navegador.
